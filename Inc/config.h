...
//#define SEGA_JOY2_UP_Z 		    HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_12)
//#define SEGA_JOY2_DOWN_Y      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13)
//#define SEGA_JOY2_LEFT_X      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_14)
//#define SEGA_JOY2_RIGHT_MODE  HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_15)
//#define SEGA_JOY2_A_B         HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_8)
//#define SEGA_JOY2_C_START     HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_9)
//#define SEGA_JOY2_SELECT(val) HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, val)
