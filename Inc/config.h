...
#define SEGA_JOY1_DOWN_Y      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13) // SPI2 SCK
#define SEGA_JOY1_LEFT_X      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_14) // SPI2 MISO
#define SEGA_JOY1_RIGHT_MODE  HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_15) // SPI2 MOSI
...
#define SEGA_JOY2_UP_Z 		    HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_7)
#define SEGA_JOY2_DOWN_Y      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_8)
#define SEGA_JOY2_LEFT_X      HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_15)
#define SEGA_JOY2_RIGHT_MODE  HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_3) // SPI1 SCK
#define SEGA_JOY2_A_B         HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_4) // SPI1 MISO
#define SEGA_JOY2_C_START     HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_5) // SPI1 MOSI
